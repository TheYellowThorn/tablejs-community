...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.5", ngImport: i0, type: ScrollViewportDirective, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: GridService }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }, { type: DirectiveRegistrationService }, { type: ScrollDispatcherService }, { type: OperatingSystemService }, { type: i0.ChangeDetectorRef }, { type: i0.RendererFactory2 }]; }, propDecorators: { templateRef: [{
                type: ContentChild,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.5", ngImport: i0, type: GridDirective, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: i0.ComponentFactoryResolver }, { type: GridService }, { type: DirectiveRegistrationService }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }, { type: i3.Overlay }, { type: ScrollDispatcherService }, { type: OperatingSystemService }, { type: i0.RendererFactory2 }]; }, propDecorators: { linkClass: [{
                type: Input
