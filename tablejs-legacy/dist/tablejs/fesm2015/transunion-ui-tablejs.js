...
import { Component, ViewEncapsulation, ViewContainerRef, ChangeDetectorRef, ViewChild, Injectable, Directive, TemplateRef, IterableDiffers, ElementRef, Input, EventEmitter, Inject, ComponentFactoryResolver, RendererFactory2, ContentChild, Output, InjectionToken, Injector, HostListener, NgModule, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
DirectiveRegistrationService.ɵprov = i0.ɵɵdefineInjectable({ factory: function DirectiveRegistrationService_Factory() { return new DirectiveRegistrationService(i0.ɵɵinject(GridService)); }, token: DirectiveRegistrationService, providedIn: "root" });
