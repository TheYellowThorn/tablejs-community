import { AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, OnInit, TemplateRef, OnDestroy, RendererFactory2, ComponentFactoryResolver } from '@angular/core';
...
export declare class ScrollViewportDirective implements AfterViewInit, OnDestroy, OnInit {
    ...
    private renderer;
    constructor(elementRef: ElementRef, gridService: GridService, document: any, directiveRegistrationService: DirectiveRegistrationService, scrollDispatcherService: ScrollDispatcherService, operatingSystem: OperatingSystemService, componentFactoryResolver: ComponentFactoryResolver, cdr: ChangeDetectorRef | null, rendererFactory: RendererFactory2);
...
//# sourceMappingURL=scroll-viewport.directive.d.ts.map