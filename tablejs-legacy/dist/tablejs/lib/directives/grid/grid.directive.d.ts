import { AfterViewInit, ComponentRef, ComponentFactoryResolver, ElementRef, EventEmitter, OnDestroy, InjectionToken, ViewContainerRef, RendererFactory2 } from '@angular/core';
...
export declare class GridDirective extends TablejsGridProxy implements AfterViewInit, OnDestroy {
    ...
    constructor(viewContainerRef: ViewContainerRef, elementRef: ElementRef, resolver: ComponentFactoryResolver, gridService: GridService, directiveRegistrationService: DirectiveRegistrationService, document: any, overlay: Overlay, scrollDispatcherService: ScrollDispatcherService, operatingSystem: OperatingSystemService, rendererFactory: RendererFactory2);
