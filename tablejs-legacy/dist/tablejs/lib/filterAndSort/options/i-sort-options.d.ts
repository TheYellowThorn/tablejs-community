...
export interface ISortOptions extends IAbstractOptions {
    ...
    directionOrder: (number | SortDirection.ASCENDING | SortDirection.DESCENDING | SortDirection.NONE)[];
    sortDirection: number | SortDirection.ASCENDING | SortDirection.DESCENDING | SortDirection.NONE;
}
//# sourceMappingURL=i-sort-options.d.ts.map