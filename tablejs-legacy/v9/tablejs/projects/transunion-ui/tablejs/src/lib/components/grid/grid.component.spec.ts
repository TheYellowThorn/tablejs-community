...
@Component({
  ...
  template: `<tablejs-grid [dragAndDropGhostFilter]="dragAndDropGhostFilter" [linkClass]="linkClass" [resizeColumnWidthByPercent]="resizeColumnWidthByPercent"
...
class TablejsTestWrapperComponent {
  ...
  dragAndDropGhostFilter = (item: any) => true;
