...
describe('DataColClassDirective', () => {
  ...
  describe('ngAfterViewInit()', () => {
    ...
    it('should register initialWidth', fakeAsync(() => {
      ...
      const spy = spyOn(directive, 'registerInitialColumnWidthOnOnGridDirective');
  ...
  describe('registerInitialColumnWidthOnOnGridDirective()', () => {
    describe('initialWidth is undefined', () => {
      it('should call triggerHasInitialWidths with false', () => {
        ...
        directive.registerInitialColumnWidthOnOnGridDirective();
